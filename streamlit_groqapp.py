...
def generate_response(user_input):
    ...
    system_instruction = """
   reformuler chaque non-conformité en langue française et en langue anglaise, en utilisant les instructions suivantes :
Référez-vous aux documents dela norme IFSv8  en priorité.
